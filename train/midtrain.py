...
from train.data import TextJsonlDataset


def _run_lm(
    cfg_path: str,
    default_jsonl_key: str,
    desc: str,
    max_iters: int | None,
...
def main_mid() -> None:
    ...
    p.add_argument("--config", default="configs/mid.yaml")
    p.add_argument("--max-iters", type=int, default=None)
    p.add_argument("--max-seconds", type=float, default=None)
    args = p.parse_args()
    _run_lm(args.config, "mix_jsonl", "mid", args.max_iters, args.max_seconds)
...
def main_sft() -> None:
    ...
    p.add_argument("--max-seconds", type=float, default=None)
    args = p.parse_args()
    _run_lm(args.config, "data_jsonl", "sft", args.max_iters, args.max_seconds)
